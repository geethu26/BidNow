...
function createAuctionCard(auction) {
  ...
  <div class="col-lg-4 col-md-6 mb-4">
    <div class="card auction-card">
      <img src="${auction.image}" class="card-img-top lazy-load" loading="lazy" alt="${auction.title}" style="height: 250px; object-fit: cover;">
      <div class="card-body">
...
function updateCountdowns() {
    document
        .querySelectorAll(".countdown-timer")
        .forEach((timer) => {
...
function placeBid(auctionId) {
    ...
    if (!isNaN(bidAmount) && bidAmount >= minBid) {
        ...
        const userBids = stored ? JSON.parse(stored) : [];
        const newBid = {
            id: Date.now(),
